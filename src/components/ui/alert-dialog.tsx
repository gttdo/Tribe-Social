...
>(({ className, children, ...props }, ref) => {
  ...
  const titleId = React.useId() + "-alert-title";
  const descriptionId = React.useId() + "-alert-description";
  ...
  return (
    <AlertDialogPortal>
      ...
      <AlertDialogPrimitive.Content
        ...
        {...props}
      >
        {/* Hidden accessibility title for screen readers */}
        <VisuallyHidden>
          <AlertDialogPrimitive.Title id={titleId}>
            Alert Dialog
